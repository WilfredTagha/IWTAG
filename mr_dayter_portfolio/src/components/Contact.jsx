        ...
        <div className="contact-layout">
          ...
          <div>
            ...
            <p className="s-desc" style={{ marginBottom:28 }}>
              Let's build something impactful together — whether it's your data infrastructure, analytics stack, or your next big data product.
            </p>

            <div className="form-row">
              <div className="form-g" style={{ marginBottom:0 }}>
                <label className="form-lbl">Name</label>
                <input className="form-in" name="name" value={form.name} onChange={set} placeholder="John Smith" />
              </div>
              <div className="form-g" style={{ marginBottom:0 }}>
                <label className="form-lbl">Email</label>
                <input className="form-in" name="email" type="email" value={form.email} onChange={set} placeholder="john@company.com" />
              </div>
            </div>

            <div className="form-g">
              <label className="form-lbl">Service Needed?</label>
              <select className="form-sel" name="service" value={form.service} onChange={set}>
            ...
            <div className="form-g">
              <label className="form-lbl">What Can I Help You...</label>
              <textarea className="form-ta" name="message" value={form.message} onChange={set} placeholder="Hello, I'd like to enquire about..." />
            </div>
